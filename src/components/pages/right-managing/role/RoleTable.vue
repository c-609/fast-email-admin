<template>
  <div>
    ...
    <el-dialog title="修改权限" :visible.sync="dialogTransferVisible" @close="closeDialog">
      <el-tree
        :data="menuData"
        ref="menuData"
        show-checkbox
...
import {
  ...
  updateRole,
  updateRoleDept
} from "./../../../../api/right-managing/role.js";
...
export default {
  ...
  methods: {
    ...
    handleDialogSure() {
      var m = this.$refs.menuData
        .getCheckedKeys()
        .concat(this.$refs.menuData.getHalfCheckedKeys());
      var mids = m.join(",");
      var _this = this;
